...
<main>
    <div class="content-container">
        <div class='form-wrapper'>
            ...
            <table>
                ...
                <tr>
                    <th>입고 일자</th>
                    <td>
                        <input type='text' class='datepicker' name='inDate' id='inDate' inputmode='none'/>
                    </td>
                </tr>
                <tr>
                    <th>입고 수량</th>
        ...
        <div class='mt30 center'>
            <input type='button' class='btn btn-large primary' id='btnRegister' value='입고 등록' />
        </div>
    </div>
...
const register = () => {    
    ...
    formData.append('inDate', document.getElementById('inDate').value);
...
const getItemsInOutList = async ({
    ...
    let where = `where classification='입고'`;
