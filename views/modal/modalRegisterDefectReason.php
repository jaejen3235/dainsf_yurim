<div class="modal" id="modalRegisterDefectReason">
	<div class="modal-content">
		<div class="modal-header">
			<span class='modal-title'>불량 사유 등록</span>
		...
		<div class="modal-body center" style="overflow:auto">
            <form id='frm'>
                ...
                <input type='hidden' name='mode' id='mode' value='registerDefectReason' />
                <input type='hidden' class='input' name='uid' id='uid' value="<?=$_GET['uid']?>" />
                ...
                <table class='register'>
                    ...
                    <tr>
                        <td><i class='bx bx-check'></i> 불량 사유명</td>
                        <td>
    ...
    try {
        ...
        if(btnClose) {
            btnClose.addEventListener('click', function() {
                clearn();
                closeModal('modalRegisterDefectReason');
            });
        }
    } catch(e) {}
    ...
    try {
        ...
        if (btnRegister) {            
            btnRegister.addEventListener('click', () => {
                // 배열을 전달하여 함수 호출
                const fieldsArray = [
                    { id: 'name', message: '불량 사유명을 입력하세요', type: 'text' }
                ];
...
const getter = async (uid) => {  
    ...
    formData.append('mode', 'getDefectReason');
