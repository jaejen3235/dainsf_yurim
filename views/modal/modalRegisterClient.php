<div class="modal" id="modalRegisterClient">
	<div class="modal-content">
		<div class="modal-header">
			<span class='modal-title'>고객사 등록</span>
		...
		<div class="modal-body center" style="overflow:auto">
            <form id='frm'>
                ...
                <table class='register'>
                    ...
                    <tr>
                        <td><i class='bx bx-check'></i> 고객사명</td>
                        <td>
                            <input type='text' class='input' name='name' id='name' />
                        </td>
                    </tr>
                    <tr>
                        <td><i class='bx bx-check'></i> 로고</td>
                        <td>
    ...
    try {
        ...
        if(btnClose) {
            btnClose.addEventListener('click', () => {
                clearn();
                closeModal('modalRegisterClient');
            });
        }
    } catch(e) {}
    ...
    try {
        ...
        if (btnRegister) {
            btnRegister.addEventListener('click', () => {
                // 배열을 전달하여 함수 호출
                const fieldsArray = [
                    { id: 'name', message: '고객사명을 입력하세요', type: 'text' },
                    { id: 'logo', message: '로고를 등록하세요', type: 'file' }
                ];
