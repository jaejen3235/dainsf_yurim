<div class="modal" id="modalRegisterQualityInspection">
	<div class="modal-content">
		<div class="modal-header">
			<span class='modal-title'>품질검사 등록</span>
		...
		<div class="modal-body center" style="overflow:auto">
            <form id='frm'>
                ...
                <input type='hidden' name='mode' id='mode' value='registerQualityInspection' />
    ...
    try {
        ...
        if(btnClose) {
            btnClose.addEventListener('click', function() {
                clean();
                closeModal('modalRegisterQualityInspection');
            });
        }
    } catch(e) {}
