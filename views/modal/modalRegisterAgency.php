<div class="modal" id="modalRegisterAgency">
		...
		<div class="modal-body center" style="overflow:auto">
            <form id='frm'>
                ...
                <table class='register'>
                    ...
                    <tr>
                        <td><i class='bx bx-check'></i> 협력사명</td>
                        <td>
                            <input type='text' class='input' name='name' id='name' />
                        </td>
                    </tr>
                    <tr>
                        <td><i class='bx bx-check'></i> 협력사 코드</td>
                        <td>
                            <input type='text' class='input' name='code' id='code' />
                        </td>
                    </tr>
                    <tr>
                        <td><i class='bx bx-check'></i> 담당자</td>
                        <td>
                            <input type='text' class='input' name='adminName' id='adminName' />
                        </td>
                    </tr>
                    <tr>
                        <td><i class='bx bx-check'></i> 연락처</td>
                        <td>
