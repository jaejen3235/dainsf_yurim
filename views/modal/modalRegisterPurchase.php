<div class="modal" id="modalRegisterPurchase">
	<div class="modal-content">
		<div class="modal-header">
			<span class='modal-title'>구매 요청</span>
    ...
    try {
        ...
        if(btnClose) {
            btnClose.addEventListener('click', function() {
                clean();
                closeModal('modalRegisterPurchase');
            });
        }
    } catch(e) {}
...
const setter = (data) => {
    if (data) {        
        document.getElementById('classification_name').innerHTML = data.classification;        
        ...
        document.getElementById('stock_qty').innerHTML = data.stock_qty;
        document.getElementById('safety_stock_qty').innerHTML = data.safety_stock_qty;
    }
}
</script>