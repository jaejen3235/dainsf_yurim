...
const generateTableContent = (data) => {
    ...
    return data.data.map(item => `
        <tr>
            ...
            <td class='center'>
                <input type='button' class='btn-small primary' value='원가 등록' onclick='registerCost(${item.uid})' />
...
const registerCost = (uid) => {
    location.href = `?controller=items&action=registerCost&item_uid=${uid}`;
}
