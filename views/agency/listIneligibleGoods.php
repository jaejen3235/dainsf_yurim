...
const getGoodsList = async ({ page, per = 7, block = 4, where = `where integrity='N'`, orderBy = DEFAULT_ORDER_BY, order = DEFAULT_ORDER }) => {
...
const generateTableContent = (data) => {
    ...
    return data.map(item => `
        <tr>
            ...
            <td class='center'>${comma(item.supplement)}</td>
            <td class='center'>
