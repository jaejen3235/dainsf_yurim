    ...
    return listData.map((item, index) => {
        ...
        return `
            <tr> 
                ...
                <td class='center hands' onclick="movePage('agency', 'viewBuy', ${item.uid})">${item.agencyName}</td>
                <td class='center hands' onclick="movePage('agency', 'viewBuy', ${item.uid})">${item.clientName}</td>
                <td class='center hands' onclick="movePage('agency', 'viewBuy', ${item.uid})">${item.mobile}</td>
                <td class='center hands' onclick="movePage('agency', 'viewBuy', ${item.uid})">${item.deviceName}</td>
                <td class='center hands' onclick="movePage('agency', 'viewBuy', ${item.uid})">${item.deviceModel}</td>
                <td class='center hands' onclick="movePage('agency', 'viewBuy', ${item.uid})">${item.payment}</td>
                <td class='center hands' onclick="movePage('agency', 'viewBuy', ${item.uid})">${item.state}</td>
