<div class="content-wrapper">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                ...
                <div class="stat-content">
                    <div class="stat-label">전체 검사 수</div>
                    <div class="stat-value" id="totalInspection">0</div>
                </div>
            </div>
            <div class="stat-card">
            ...
            <div class="stat-card">
                ...
                <div class="stat-content">
                    ...
                    <div class="stat-value" id="defectRate">0.00%</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="table-section">
        <div class="table-header">
            ...
            <div class="table-actions">
                <span class="record-count">총 <strong id="recordCount">0</strong>건</span>
            </div>
        </div>
        <div class="table-wrapper">
            <table class="data-table" id="inspectionTable">
                ...
                <tbody id="inspectionTableBody">
                    <!-- 데이터가 동적으로 로드됩니다 -->
                    <tr>
                        <td colspan="10" class="no-data">조회된 데이터가 없습니다.</td>
                    </tr>
                </tbody>
            </table>
        </div>
    ...
    <div class="chart-section" style="margin-top: 30px;">
        <div class="chart-header">
            <h3>불량률 추이</h3>
            <select id="chartPeriod" class="form-control" style="width: 150px; display: inline-block;">
...
function updateTable(data) {
    ...
    if (data.length === 0) {
        tbody.innerHTML = '<tr><td colspan="10" class="no-data">조회된 데이터가 없습니다.</td></tr>';
        return;
    }
    ...
    tbody.innerHTML = data.map((item, index) => `
        <tr>
            ...
            <td>${item.workLine || '-'}</td>
            <td><span class="${item.result === 'pass' ? 'result-pass' : 'result-fail'}">${item.result === 'pass' ? '양품' : '불량'}</span></td>
            <td>${item.detectedMetal || '-'}</td>
            <td>${item.detectedSize || '-'}</td>
