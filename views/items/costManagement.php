    ...
    <div class='search-wrapper'>
        <div class='search-box'>
            ...
            <div class='button-box'>
                <input type='button' class='btn-large primary' id='btnRegisterCost' value='원가 등록' />
            </div>
        </div>
    </div>
...
window.addEventListener('DOMContentLoaded', ()=>{
    ...
    try {
        const btnRegisterCost = document.getElementById('btnRegisterCost');
        if(btnRegisterCost) {
            location.href = '?controller=items&action=registerCost';
        }
    } catch(e) {}
